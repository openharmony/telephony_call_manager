...
#ifndef TAIHE_CALL_MANAGER_CALLBACK_H
#define TAIHE_CALL_MANAGER_CALLBACK_H
...
class TaiheCallManagerCallback : public CallManagerCallback {
public:
    TaiheCallManagerCallback();
    ~TaiheCallManagerCallback() override;
...
#endif // TAihe_CALL_MANAGER_CALLBACK_H