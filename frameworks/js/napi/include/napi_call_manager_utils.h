...
enum {
    ...
    CALL_MANAGER_SET_VONR_STATE,
    CALL_MANAGER_GET_VONR_STATE,
    CALL_MANAGER_SET_CALL_RESTRICTION_PASSWORD,
    CALL_MANAGER_SET_VOIP_CALL_STATE,
    CALL_MANAGER_CONTROL_CAMERA,
    CALL_MANAGER_SET_PREVIEW_WINDOW,
    CALL_MANAGER_SET_DISPLAY_WINDOW,
    CALL_MANAGER_SET_PAUSE_PICTURE,
    CALL_MANAGER_SET_DEVICE_DIRECTION,
    CALL_MANAGER_QUERY_CAMERA_CAPABILITIES,
    CALL_MANAGER_CANCEL_CALL_UPGRADE,
    CALL_MANAGER_SEND_USSD_RESPONSE,
};
