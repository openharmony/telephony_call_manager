...
#ifndef I_CALL_MANAGER_SERVICE_IPC_INTERFACE_CODE_H
#define I_CALL_MANAGER_SERVICE_IPC_INTERFACE_CODE_H

namespace OHOS {
namespace Telephony {
extern "C" {
enum class CallManagerInterfaceCode : uint32_t {
...
enum class CallManagerProxyType : uint32_t {
    PROXY_BLUETOOTH_CALL = 0,
}; // end extern
} // namespace Telephony
} // namespace OHOS
#endif // I_CALL_MANAGER_SERVICE_IPC_INTERFACE_CODE_H