...
enum CallManagerInterfaceCode {
    ...
    INTERFACE_SET_VOIP_CALL_INFO,
    INTERFACE_GET_VOIP_CALL_INFO,
    ...
    INTERFACE_OBSERVER_ON_MEETIME_DETAILS_CHANGE,
    INTERFACE_SEND_CALLUI_EVENT,
    INTERFACE_MAKE_CALL,
    INTERFACE_MAKE_CALL_WITH_TOKEN,
    INTERFACE_BLUETOOTH_REGISTER_CALLBACKPTR,
    INTERFACE_SEND_USSD_RESPONSE,
    INTERFACE_SET_CALL_POLICY_INFO,
    INTERFACE_END_CALL,
    INTERFACE_HAS_DISTRIBUTED_COMMUNICATION_CAPABILITY,
    INTERFACE_NOTIFY_VOIP_AUDIO_STREAM_START,
    INTERFACE_SET_RTT_CAPABILITY_SETTING,
    INTERFACE_SEND_RTT_MESSAGE,
    INTERFACE_UPDATE_RTT_CALL_MODE,
    INTERFACE_SET_CALL_AUDIO_MODE,
    INTERFACE_ANSWER_CALL_NO_PARAM,
    INTERFACE_REJECT_CALL_NO_PARAM,
    INTERFACE_DISCONNECT_CALL_NO_PARAM,
    INTERFACE_PRELOAD_CALLUI,
    INTERFACE_GET_CALL_TRANSFER_BY_NUMBER,
    INTERFACE_REGISTER_TRANSFER_CONTROLLER,
    INTERFACE_UNREGISTER_TRANSFER_CONTROLLER,
    INTERFACE_NOTIFY_TRANSFER_CALL_CONTACT,
    INTERFACE_CHECK_CALL_RECORDING_PERMISSION,
    INTERFACE_SET_REG_MMI_CODE_CALLBACK_STATE,
    INTERFACE_REJECT_CALL_WITH_TYPE,
};
} // end extern
} // namespace Telephony
} // namespace OHOS
