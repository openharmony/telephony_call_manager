...
enum ModelTypeBit {
    VOICE_MODEL_BIT = 0b1,
    PICTURE_MODEL_BIT = 0b10,
    SPEECH_SYNTHESIS_MODEL_BIT = 0b100,
    VOIP_CALL_TRANSFER_MODEL_BIT = 0b1000,
    PUBLIC_SECURITY_MODEL_BIT = 0b10000,
    WEB_ICON_MODEL_BIT = 0b100000,
    WEB_SEMANTIC_MODEL_BIT = 0b1000000
};
