...
public:
    ...
    int32_t SetSuperPrivacyPolicies(const SuperPrivacyPolicyInfo &info, int32_t source);

private:
    SuperPrivacyManagerClient();
    static constexpr int32_t COMMAND_SET_SUPER_PRIVACY_POLICIES = MIN_TRANSACTION_ID + 2;
};
} // namespace Telephony
} // namespace OHOS
