...
#ifndef TELEPHONY_DISTRIBUTED_COMMUNICATION_DEVICE_CALLBACK_I_H
#define TELEPHONY_DISTRIBUTED_COMMUNICATION_DEVICE_CALLBACK_I_H

#include <string>

namespace OHOS {
namespace Telephony {
class IDistributedDeviceCallback {
public:
...
#endif // TELEPHONY_DISTRIBUTED_COMMUNICATION_DEVICE_CALLBACK_I_H
