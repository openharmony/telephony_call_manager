...
#ifndef CALL_MANAGER1_GTEST
#define CALL_MANAGER1_GTEST
...
class CallManager1Gtest : public testing::Test {
public:
...
bool CallManager1Gtest::isConnected_ = false;
std::shared_ptr<CallManagerClient> CallManager1Gtest::clientPtr_ = nullptr;
std::shared_ptr<BluetoothCallClient> CallManager1Gtest::blueToothClientPtr_ = nullptr;
std::unique_ptr<CallManagerConnect> CallManager1Gtest::servicePtr_ = nullptr;
} // namespace Telephony
} // namespace OHOS
