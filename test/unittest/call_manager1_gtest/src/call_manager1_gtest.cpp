...
{
    if (CallManager1Gtest::clientPtr_->GetCallState() == targetState) {
        return;
    }
    int32_t usedTimeMs = 0;
    std::cout << "wait for a few seconds......" << std::endl;
    while ((CallManager1Gtest::clientPtr_->GetCallState() != targetState) && (usedTimeMs < timeoutMs)) {
        usleep(slipMs * SLEEP_1000_MS);
        usedTimeMs += slipMs;
    }
    int32_t callState = CallManager1Gtest::clientPtr_->GetCallState();
...
void CallManager1Gtest::HangUpCall()
{
 ...
 * @tc.require: I5P2WO
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_0100, Function | MediumTest | Level1)
{
    AccessToken token;
    ...
    EXPECT_EQ(CallManager1Gtest::IsServiceConnected(), true);
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        ...
        int32_t ret = CallManager1Gtest::clientPtr_->DialCall(Str8ToStr16(phoneNumber), dialInfo_);
 ...
 * @tc.require: I5P2WO
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_0200, Function | MediumTest | Level1)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        InitDialInfo(
            SIM1_SLOTID, (int32_t)VideoStateType::TYPE_VOICE, DIAL_SCENE_TEST, (int32_t)DialType::DIAL_CARRIER_TYPE);
        int32_t ret = CallManager1Gtest::clientPtr_->DialCall(Str8ToStr16(""), dialInfo_);
 ...
 * @tc.require: I5P2WO
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_0300, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: I5P2WO
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_0400, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: I5P2WO
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_0500, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        InitDialInfo(
            SIM1_SLOTID, (int32_t)VideoStateType::TYPE_VOICE, DIAL_SCENE_TEST, (int32_t)DialType::DIAL_CARRIER_TYPE);
        int32_t ret = CallManager1Gtest::clientPtr_->DialCall(Str8ToStr16("19!@#$%^&*:"), dialInfo_);
        EXPECT_EQ(ret, RETURN_VALUE_IS_ZERO);
        sleep(WAIT_TIME);
        if (clientPtr_->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
            HangUpCall();
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1000, Function | MediumTest | Level0)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        InitDialInfo(
            SIM1_SLOTID, (int32_t)VideoStateType::TYPE_VOICE, DIAL_SCENE_TEST, (int32_t)DialType::DIAL_CARRIER_TYPE);
        int32_t ret = CallManager1Gtest::clientPtr_->DialCall(Str8ToStr16("10086"), dialInfo_);
        EXPECT_EQ(ret, RETURN_VALUE_IS_ZERO);
        sleep(WAIT_TIME);
        if (clientPtr_->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
            HangUpCall();
 ...
 * @tc.require: I5P2WA
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1100, Function | MediumTest | Level0)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: I5P2WA
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1200, Function | MediumTest | Level0)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: I5P2WA
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1300, Function | MediumTest | Level0)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1400, Function | MediumTest | Level1)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        InitDialInfo(
            SIM1_SLOTID, (int32_t)VideoStateType::TYPE_VOICE, DIAL_SCENE_TEST, (int32_t)DialType::DIAL_CARRIER_TYPE);
        int32_t ret = CallManager1Gtest::clientPtr_->DialCall(Str8ToStr16("22222222222"), dialInfo_);
        EXPECT_NE(ret, RETURN_VALUE_IS_ZERO);
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1500, Function | MediumTest | Level1)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1600, Function | MediumTest | Level0)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        InitDialInfo(
            SIM1_SLOTID, INVALID_VIDEO_STATE, (int32_t)DialScene::CALL_NORMAL, (int32_t)DialType::DIAL_CARRIER_TYPE);
        int32_t ret = CallManager1Gtest::blueToothClientPtr_->DialCall(Str8ToStr16(phoneNumber), dialInfo_);
        EXPECT_EQ(ret, CALL_ERR_INVALID_VIDEO_STATE);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        InitDialInfo(
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1700, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1800, Function | MediumTest | Level1)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_1900, Function | MediumTest | Level0)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: I5P2WO
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_2000, Function | MediumTest | Level1)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        InitDialInfo(
            SIM1_SLOTID, (int32_t)VideoStateType::TYPE_VOICE, DIAL_SCENE_TEST, (int32_t)DialType::DIAL_CARRIER_TYPE);
        EXPECT_EQ(CallManager1Gtest::clientPtr_->DialCall(Str8ToStr16(phoneNumber), dialInfo_), RETURN_VALUE_IS_ZERO);
        sleep(WAIT_TIME);
        if (CallInfoManager::HasActiveStatus()) {
            EXPECT_EQ(CallManager1Gtest::clientPtr_->HoldCall(g_newCallId), RETURN_VALUE_IS_ZERO);
            sleep(WAIT_TIME);
            EXPECT_EQ(CallManager1Gtest::clientPtr_->UnHoldCall(g_newCallId), RETURN_VALUE_IS_ZERO);
        }
        sleep(WAIT_TIME);
        if (clientPtr_->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
            HangUpCall();
 ...
 * @tc.require: I5P2WO
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_DialCall_2100, Function | MediumTest | Level1)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: I5P2WA
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_AnswerCall_0100, Function | MediumTest | Level1)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager1Gtest::clientPtr_->AnswerCall(callId, videoState), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.require: I5P2WA
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_AnswerCall_0200, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_AnswerCall_0300, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager1Gtest, Telephony_CallManager_AnswerCall_0400, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    CallInfoManager::LockCallState(false, (int32_t)CallStateToApp::CALL_STATE_IDLE, SLEEP_200_MS, SLEEP_30000_MS);
    ASSERT_TRUE(blueToothClientPtr_ != nullptr);
    EXPECT_NE(CallManager1Gtest::blueToothClientPtr_->AnswerCall(), RETURN_VALUE_IS_ZERO);
}
} // namespace Telephony
} // namespace OHOS
