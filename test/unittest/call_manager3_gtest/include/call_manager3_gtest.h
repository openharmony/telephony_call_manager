...
#ifndef CALL_MANAGER3_GTEST
#define CALL_MANAGER3_GTEST
...
class CallManager3Gtest : public testing::Test {
public:
...
bool CallManager3Gtest::isConnected_ = false;
std::shared_ptr<CallManagerClient> CallManager3Gtest::clientPtr_ = nullptr;
std::shared_ptr<BluetoothCallClient> CallManager3Gtest::blueToothClientPtr_ = nullptr;
std::unique_ptr<CallManagerConnect> CallManager3Gtest::servicePtr_ = nullptr;
} // namespace Telephony
} // namespace OHOS
