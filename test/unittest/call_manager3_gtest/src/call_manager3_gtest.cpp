...
{
    if (CallManager3Gtest::clientPtr_->GetCallState() == targetState) {
        return;
    }
    int32_t usedTimeMs = 0;
    std::cout << "wait for a few seconds......" << std::endl;
    while ((CallManager3Gtest::clientPtr_->GetCallState() != targetState) && (usedTimeMs < timeoutMs)) {
        usleep(slipMs * SLEEP_1000_MS);
        usedTimeMs += slipMs;
    }
    int32_t callState = CallManager3Gtest::clientPtr_->GetCallState();
...
void CallManager3Gtest::HangUpCall()
{
 ...
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_KickOutFromConference_0400, Function | MediumTest | Level2)
{
    AccessToken token;
    ...
    EXPECT_EQ(CallManager3Gtest::clientPtr_->DialCall(Str8ToStr16(number), dialInfo_), RETURN_VALUE_IS_ZERO);
    if (CallInfoManager::HasActiveStatus()) {
        EXPECT_NE(CallManager3Gtest::clientPtr_->KickOutFromConference(g_newCallId), RETURN_VALUE_IS_ZERO);
    }
    sleep(WAIT_TIME);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_GetMainCallId_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager3Gtest::clientPtr_->GetMainCallId(callId, mainCallId), TELEPHONY_ERR_SUCCESS);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_GetMainCallId_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_GetSubCallIdList_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    list.clear();
    int32_t result = CallManager3Gtest::clientPtr_->GetSubCallIdList(callId, list);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_GetSubCallIdList_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    ans.clear();
    int32_t result = CallManager3Gtest::clientPtr_->GetSubCallIdList(callId, ans);
    EXPECT_NE(result, TELEPHONY_ERR_SUCCESS);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_GetCallIdListForConference_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    callIdList.clear();
    int32_t result = CallManager3Gtest::clientPtr_->GetCallIdListForConference(callId, callIdList);
    EXPECT_NE(result, TELEPHONY_ERR_SUCCESS);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_GetCallIdListForConference_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    std::vector<std::u16string> ans;
    ans.clear();
    int32_t result = CallManager3Gtest::clientPtr_->GetCallIdListForConference(callId, ans);
    EXPECT_NE(result, TELEPHONY_ERR_SUCCESS);
    bool isEmpty = ans.empty();
    EXPECT_EQ(isEmpty, true);
    if (!ans.empty()) {
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_IsEmergencyPhoneNumber_0100, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        bool enabled = false;
        int32_t result = CallManager3Gtest::clientPtr_->IsEmergencyPhoneNumber(phoneNumber, SIM1_SLOTID, enabled);
        EXPECT_EQ(result, TELEPHONY_ERR_SUCCESS);
        EXPECT_NE(enabled, true);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        bool enabled = false;
        int32_t result = CallManager3Gtest::clientPtr_->IsEmergencyPhoneNumber(phoneNumber, SIM2_SLOTID, enabled);
        EXPECT_EQ(result, TELEPHONY_ERR_SUCCESS);
        EXPECT_NE(enabled, true);
    }
}
 ...
 * @tc.require: I5O1OQ
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_IsEmergencyPhoneNumber_0200, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_IsEmergencyPhoneNumber_0300, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        bool enabled = false;
        int32_t result = CallManager3Gtest::clientPtr_->IsEmergencyPhoneNumber(number, SIM1_SLOTID, enabled);
        EXPECT_EQ(result, TELEPHONY_ERR_SUCCESS);
        EXPECT_EQ(enabled, true);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        bool enabled = false;
        int32_t result = CallManager3Gtest::clientPtr_->IsEmergencyPhoneNumber(number, SIM2_SLOTID, enabled);
        EXPECT_EQ(result, TELEPHONY_ERR_SUCCESS);
        EXPECT_EQ(enabled, true);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_IsEmergencyPhoneNumber_0400, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_IsEmergencyPhoneNumber_0500, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    std::u16string phoneNumber = Str8ToStr16(number);
    bool enabled = false;
    int32_t result = CallManager3Gtest::clientPtr_->IsEmergencyPhoneNumber(phoneNumber, slotId, enabled);
    EXPECT_EQ(result, TELEPHONY_ERR_SUCCESS);
    EXPECT_EQ(enabled, true);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_IsEmergencyPhoneNumber_0600, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_IsEmergencyPhoneNumber_0700, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_IsEmergencyPhoneNumber_1000, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_GetCallWaiting_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager3Gtest::clientPtr_->GetCallWaiting(SIM1_SLOTID), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager3Gtest::clientPtr_->GetCallWaiting(SIM2_SLOTID), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_GetCallWaiting_0200, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager3Gtest::clientPtr_->GetCallWaiting(SIM1_SLOTID), TELEPHONY_ERR_PERMISSION_ERR);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager3Gtest::clientPtr_->GetCallWaiting(SIM2_SLOTID), TELEPHONY_ERR_PERMISSION_ERR);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_StartDtmf_0100, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t callId = INVALID_NEGATIVE_ID;
    char str = '1';
    EXPECT_NE(CallManager3Gtest::clientPtr_->StartDtmf(callId, str), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_StartDtmf_0200, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_StartDtmf_0300, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager3Gtest::blueToothClientPtr_->StartDtmf(str), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_StartDtmf_0400, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    EXPECT_EQ(CallManager3Gtest::IsServiceConnected(), true);
    if (clientPtr_->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        HangUpCall();
    }
    CallInfoManager::LockCallState(false, (int32_t)CallStateToApp::CALL_STATE_IDLE, SLEEP_200_MS, SLEEP_30000_MS);
    ...
    int32_t ret = CallManager3Gtest::clientPtr_->DialCall(Str8ToStr16(phoneNumber), dialInfo_);
    ...
    if (CallInfoManager::HasActiveStatus()) {
        EXPECT_EQ(CallManager3Gtest::clientPtr_->StartDtmf(g_newCallId, '1'), RETURN_VALUE_IS_ZERO);
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_StopDtmf_0100, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t callId = INVALID_NEGATIVE_ID;
    EXPECT_NE(CallManager3Gtest::clientPtr_->StopDtmf(callId), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_StopDtmf_0200, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_StopDtmf_0300, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    ASSERT_TRUE(blueToothClientPtr_ != nullptr);
    EXPECT_NE(CallManager3Gtest::blueToothClientPtr_->StopDtmf(), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_StopDtmf_0400, Function | MediumTest | Level2)
{
    AccessToken token;
    std::string phoneNumber = "10086";
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
    ...
    if (CallInfoManager::HasActiveStatus()) {
        sleep(WAIT_TIME);
        EXPECT_EQ(CallManager3Gtest::clientPtr_->StopDtmf(g_newCallId), RETURN_VALUE_IS_ZERO);
    }
    if (clientPtr_->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        sleep(WAIT_TIME);
        HangUpCall();
 ...
 */
HWTEST_F(
    CallManager3Gtest, Telephony_CallManager_PostDialProceed_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t callId = 0;
    bool proceed = false;
    EXPECT_NE(CallManager3Gtest::clientPtr_->PostDialProceed(callId, proceed), RETURN_VALUE_IS_ZERO);
}
 ...
 */
HWTEST_F(
    CallManager3Gtest, Telephony_CallManager_PostDialProceed_0200, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_PostDialProceed_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        ...
        InitDialInfo(SIM1_SLOTID, (int32_t)VideoStateType::TYPE_VOICE, (int32_t)DialScene::CALL_NORMAL,
            (int32_t)DialType::DIAL_CARRIER_TYPE);
        int32_t ret = CallManager3Gtest::clientPtr_->DialCall(Str8ToStr16("10086;123"), dialInfo_);
        EXPECT_EQ(ret, RETURN_VALUE_IS_ZERO);
        CallInfoManager::LockCallState(false, (int32_t)CallStateToApp::CALL_STATE_OFFHOOK, SLEEP_200_MS,
            SLEEP_30000_MS);
        if (CallInfoManager::HasActiveStatus()) {
            sleep(1);
            EXPECT_EQ(CallManager3Gtest::clientPtr_->PostDialProceed(g_newCallId, true), RETURN_VALUE_IS_ZERO);
        }
        if (clientPtr_->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
            sleep(1);
            HangUpCall();
    ...
    if (HasSimCard(SIM2_SLOTID)) {
        ...
        InitDialInfo(SIM2_SLOTID, (int32_t)VideoStateType::TYPE_VOICE, (int32_t)DialScene::CALL_NORMAL,
            (int32_t)DialType::DIAL_CARRIER_TYPE);
        int32_t ret = CallManager3Gtest::clientPtr_->DialCall(Str8ToStr16("10086;456"), dialInfo_);
        EXPECT_EQ(ret, RETURN_VALUE_IS_ZERO);
        CallInfoManager::LockCallState(false, (int32_t)CallStateToApp::CALL_STATE_OFFHOOK, SLEEP_200_MS,
            SLEEP_30000_MS);
        if (CallInfoManager::HasActiveStatus()) {
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_FormatPhoneNumber_0100, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    EXPECT_EQ(
        CallManager3Gtest::clientPtr_->FormatPhoneNumber(phonyNumber, countryCode, formatNumber), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_FormatPhoneNumber_0200, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_FormatPhoneNumber_0300, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_FormatPhoneNumber_0400, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_FormatPhoneNumber_0500, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_FormatPhoneNumber_0600, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_FormatPhoneNumber_0700, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager3Gtest, Telephony_CallManager_FormatPhoneNumberToE164_0100, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    std::u16string countryCode = Str8ToStr16(Code);
    std::u16string formatNumber = Str8ToStr16(formatBefore);
    EXPECT_EQ(CallManager3Gtest::clientPtr_->FormatPhoneNumberToE164(phonyNumber, countryCode, formatNumber),
