...
#ifndef CALL_MANAGER4_GTEST
#define CALL_MANAGER4_GTEST
...
class CallManager4Gtest : public testing::Test {
public:
...
bool CallManager4Gtest::isConnected_ = false;
std::shared_ptr<CallManagerClient> CallManager4Gtest::clientPtr_ = nullptr;
std::shared_ptr<BluetoothCallClient> CallManager4Gtest::blueToothClientPtr_ = nullptr;
std::unique_ptr<CallManagerConnect> CallManager4Gtest::servicePtr_ = nullptr;
} // namespace Telephony
} // namespace OHOS
