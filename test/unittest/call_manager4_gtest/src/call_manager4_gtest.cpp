...
{
    if (CallManager4Gtest::clientPtr_->GetCallState() == targetState) {
        return;
    }
    int32_t usedTimeMs = 0;
    std::cout << "wait for a few seconds......" << std::endl;
    while ((CallManager4Gtest::clientPtr_->GetCallState() != targetState) && (usedTimeMs < timeoutMs)) {
        usleep(slipMs * SLEEP_1000_MS);
        usedTimeMs += slipMs;
    }
    int32_t callState = CallManager4Gtest::clientPtr_->GetCallState();
...
void CallManager4Gtest::HangUpCall()
{
 ...
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_FormatPhoneNumberToE164_0200, Function | MediumTest | Level2)
{
    ...
    EXPECT_EQ(CallManager4Gtest::clientPtr_->FormatPhoneNumberToE164(phonyNumber, countryCode, formatNumber),
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_FormatPhoneNumberToE164_0300, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_FormatPhoneNumberToE164_0400, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_FormatPhoneNumberToE164_0500, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_FormatPhoneNumberToE164_0600, Function | MediumTest | Level2)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_FormatPhoneNumberToE164_0700, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_FormatPhoneNumberToE164_0800, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    std::u16string countryCode = Str8ToStr16(Code);
    std::u16string formatNumber = Str8ToStr16(formatBefore);
    EXPECT_NE(CallManager4Gtest::clientPtr_->FormatPhoneNumberToE164(phonyNumber, countryCode, formatNumber),
        RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallWaiting_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(SIM1_SLOTID, true), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(SIM2_SLOTID, true), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallWaiting_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(INVALID_SLOT_ID, true), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallWaiting_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(slotId, true), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallWaiting_0400, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(SIM1_SLOTID, false), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(SIM2_SLOTID, false), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallWaiting_0500, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(INVALID_SLOT_ID, false), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallWaiting_0600, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(slotId, false), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallWaiting_0700, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(SIM1_SLOTID, true), TELEPHONY_ERR_PERMISSION_ERR);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallWaiting(SIM2_SLOTID, true), TELEPHONY_ERR_PERMISSION_ERR);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallRestriction_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->GetCallRestriction(
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallRestriction_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallRestriction_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(
        CallManager4Gtest::clientPtr_->GetCallRestriction(slotId, CallRestrictionType::RESTRICTION_TYPE_ALL_INCOMING),
        CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallRestriction_0400, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallRestriction_0500, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallRestriction_0600, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(
        CallManager4Gtest::clientPtr_->GetCallRestriction(slotId, CallRestrictionType::RESTRICTION_TYPE_ALL_OUTGOING),
        CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallRestriction_0700, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestriction_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestriction(SIM1_SLOTID, info), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestriction(SIM2_SLOTID, info), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestriction_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestriction(INVALID_SLOT_ID, info), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestriction_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestriction(slotId, info), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestriction_0400, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestriction(SIM1_SLOTID, info), TELEPHONY_ERR_PERMISSION_ERR);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestriction(SIM2_SLOTID, info), TELEPHONY_ERR_PERMISSION_ERR);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestrictionPassword_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestrictionPassword(SIM1_SLOTID, fac, oldPassword, newPassword),
            RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestrictionPassword(SIM2_SLOTID, fac, oldPassword, newPassword),
            RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestrictionPassword_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestrictionPassword(INVALID_SLOT_ID, fac, oldPassword, newPassword),
        CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestrictionPassword_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(CallManager4Gtest::clientPtr_->SetCallRestrictionPassword(slotId, fac, oldPassword, newPassword),
        CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestrictionPassword_0400, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestrictionPassword_0500, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_SetCallRestrictionPassword_0600, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallTransferInfo_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->GetCallTransferInfo(SIM1_SLOTID, CallTransferType::TRANSFER_TYPE_BUSY),
            RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->GetCallTransferInfo(SIM1_SLOTID, CallTransferType::TRANSFER_TYPE_BUSY),
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallTransferInfo_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager4Gtest::clientPtr_->GetCallTransferInfo(INVALID_SLOT_ID, CallTransferType::TRANSFER_TYPE_BUSY),
        CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallTransferInfo_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(CallManager4Gtest::clientPtr_->GetCallTransferInfo(slotId, CallTransferType::TRANSFER_TYPE_BUSY),
        CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallTransferInfo_0400, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(
            CallManager4Gtest::clientPtr_->GetCallTransferInfo(SIM1_SLOTID, CallTransferType::TRANSFER_TYPE_NO_REPLY),
            RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(
            CallManager4Gtest::clientPtr_->GetCallTransferInfo(SIM2_SLOTID, CallTransferType::TRANSFER_TYPE_NO_REPLY),
            RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallTransferInfo_0500, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(
        CallManager4Gtest::clientPtr_->GetCallTransferInfo(INVALID_SLOT_ID, CallTransferType::TRANSFER_TYPE_NO_REPLY),
        CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallTransferInfo_0600, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(CallManager4Gtest::clientPtr_->GetCallTransferInfo(slotId, CallTransferType::TRANSFER_TYPE_NO_REPLY),
        CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallTransferInfo_0700, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager4Gtest::clientPtr_->GetCallTransferInfo(
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager4Gtest, Telephony_CallManager_GetCallTransferInfo_0800, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
