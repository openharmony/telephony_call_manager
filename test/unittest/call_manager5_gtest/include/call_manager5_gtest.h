...
#ifndef CALL_MANAGER5_GTEST
#define CALL_MANAGER5_GTEST
...
class CallManager5Gtest : public testing::Test {
public:
...
bool CallManager5Gtest::isConnected_ = false;
std::shared_ptr<CallManagerClient> CallManager5Gtest::clientPtr_ = nullptr;
std::shared_ptr<BluetoothCallClient> CallManager5Gtest::blueToothClientPtr_ = nullptr;
std::unique_ptr<CallManagerConnect> CallManager5Gtest::servicePtr_ = nullptr;
} // namespace Telephony
} // namespace OHOS
