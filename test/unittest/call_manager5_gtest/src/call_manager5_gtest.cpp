...
{
    if (CallManager5Gtest::clientPtr_->GetCallState() == targetState) {
        return;
    }
    int32_t usedTimeMs = 0;
    std::cout << "wait for a few seconds......" << std::endl;
    while ((CallManager5Gtest::clientPtr_->GetCallState() != targetState) && (usedTimeMs < timeoutMs)) {
        usleep(slipMs * SLEEP_1000_MS);
        usedTimeMs += slipMs;
    }
    int32_t callState = CallManager5Gtest::clientPtr_->GetCallState();
...
void CallManager5Gtest::HangUpCall()
{
 ...
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_GetCallTransferInfo_0900, Function | MediumTest | Level3)
{
    AccessToken token;
    ...
    EXPECT_EQ(CallManager5Gtest::clientPtr_->GetCallTransferInfo(slotId, CallTransferType::TRANSFER_TYPE_NOT_REACHABLE),
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_GetCallTransferInfo_1000, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->GetCallTransferInfo(SIM1_SLOTID, (CallTransferType)FALSE_DEFAULT),
            CALL_ERR_INVALID_TRANSFER_TYPE);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->GetCallTransferInfo(SIM2_SLOTID, (CallTransferType)FALSE_DEFAULT),
            CALL_ERR_INVALID_TRANSFER_TYPE);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_GetCallTransferInfo_1100, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->GetCallTransferInfo(SIM1_SLOTID, CallTransferType::TRANSFER_TYPE_BUSY),
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetCallTransferInfo_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetCallTransferInfo(SIM1_SLOTID, info), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetCallTransferInfo(SIM2_SLOTID, info), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetCallTransferInfo_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager5Gtest::clientPtr_->SetCallTransferInfo(INVALID_SLOT_ID, info), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetCallTransferInfo_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(CallManager5Gtest::clientPtr_->SetCallTransferInfo(slotId, info), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetCallTransferInfo_0400, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetCallTransferInfo_0500, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetCallTransferInfo_0600, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetCallTransferInfo(SIM1_SLOTID, info), CALL_ERR_NUMBER_OUT_OF_RANGE);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetCallTransferInfo(SIM2_SLOTID, info), CALL_ERR_NUMBER_OUT_OF_RANGE);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetCallTransferInfo_0700, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetCallTransferInfo(SIM1_SLOTID, info), TELEPHONY_ERR_PERMISSION_ERR);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetCallTransferInfo(SIM2_SLOTID, info), TELEPHONY_ERR_PERMISSION_ERR);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_EnableImsSwitch_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->EnableImsSwitch(SIM1_SLOTID), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->EnableImsSwitch(SIM2_SLOTID), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_EnableImsSwitch_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager5Gtest::clientPtr_->EnableImsSwitch(INVALID_SLOT_ID), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_EnableImsSwitch_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(CallManager5Gtest::clientPtr_->EnableImsSwitch(slotId), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_EnableImsSwitch_0400, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->EnableImsSwitch(SIM1_SLOTID), TELEPHONY_ERR_PERMISSION_ERR);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->EnableImsSwitch(SIM2_SLOTID), TELEPHONY_ERR_PERMISSION_ERR);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_DisableImsSwitch_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->DisableImsSwitch(SIM1_SLOTID), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->DisableImsSwitch(SIM2_SLOTID), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_DisableImsSwitch_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager5Gtest::clientPtr_->DisableImsSwitch(INVALID_SLOT_ID), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_DisableImsSwitch_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(CallManager5Gtest::clientPtr_->DisableImsSwitch(slotId), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_IsImsSwitchEnabled_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    bool enabled;
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->IsImsSwitchEnabled(SIM1_SLOTID, enabled), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->IsImsSwitchEnabled(SIM2_SLOTID, enabled), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_IsImsSwitchEnabled_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    bool enabled;
    EXPECT_EQ(CallManager5Gtest::clientPtr_->IsImsSwitchEnabled(INVALID_SLOT_ID, enabled), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_IsImsSwitchEnabled_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    bool enabled;
    EXPECT_EQ(CallManager5Gtest::clientPtr_->IsImsSwitchEnabled(slotId, enabled), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetVoNRState_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t state = 0;
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetVoNRState(SIM1_SLOTID, state), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetVoNRState(SIM2_SLOTID, state), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetVoNRState_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetVoNRState_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t state = 0;
    EXPECT_EQ(CallManager5Gtest::clientPtr_->SetVoNRState(INVALID_SLOT_ID, state), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetVoNRState_0400, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t state = 0;
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    EXPECT_EQ(CallManager5Gtest::clientPtr_->SetVoNRState(slotId, state), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetVoNRState_0500, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t state = -1;
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetVoNRState(SIM1_SLOTID, state), TELEPHONY_ERR_ARGUMENT_INVALID);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetVoNRState(SIM2_SLOTID, state), TELEPHONY_ERR_ARGUMENT_INVALID);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetVoNRState_0600, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    int32_t state = 0;
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetVoNRState(SIM1_SLOTID, state), TELEPHONY_ERR_PERMISSION_ERR);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->SetVoNRState(SIM2_SLOTID, state), TELEPHONY_ERR_PERMISSION_ERR);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_GetVoNRState_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t state;
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->GetVoNRState(SIM1_SLOTID, state), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->GetVoNRState(SIM2_SLOTID, state), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_GetVoNRState_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t state;
    EXPECT_EQ(CallManager5Gtest::clientPtr_->GetVoNRState(INVALID_SLOT_ID, state), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_GetVoNRState_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    int32_t slotId = SIM_SLOT_COUNT; // out of the count
    int32_t state;
    EXPECT_EQ(CallManager5Gtest::clientPtr_->GetVoNRState(slotId, state), CALL_ERR_INVALID_SLOT_ID);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_GetVoNRState_0400, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    int32_t state;
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->GetVoNRState(SIM1_SLOTID, state), TELEPHONY_ERR_PERMISSION_ERR);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager5Gtest::clientPtr_->GetVoNRState(SIM2_SLOTID, state), TELEPHONY_ERR_PERMISSION_ERR);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_ControlCamera_0100, Function | MediumTest | Level0)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager5Gtest::clientPtr_->ControlCamera(callId, cameraID), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_ControlCamera_0200, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_ControlCamera_0300, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_ControlCamera_0600, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetPreviewWindow_0100, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager5Gtest::clientPtr_->SetPreviewWindow(callId, previewSurfaceId), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetPreviewWindow_0200, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetDisplayWindow_0100, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager5Gtest::clientPtr_->SetDisplayWindow(callId, displaySurfaceId), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetDisplayWindow_0200, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetDeviceDirection_0100, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager5Gtest::clientPtr_->SetDeviceDirection(callId, rotation), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetDeviceDirection_0200, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager5Gtest, Telephony_CallManager_SetDeviceDirection_0300, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
