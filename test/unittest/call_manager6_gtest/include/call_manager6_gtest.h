...
#ifndef CALL_MANAGER6_GTEST
#define CALL_MANAGER6_GTEST
...
class CallManager6Gtest : public testing::Test {
public:
...
bool CallManager6Gtest::isConnected_ = false;
std::shared_ptr<CallManagerClient> CallManager6Gtest::clientPtr_ = nullptr;
std::shared_ptr<BluetoothCallClient> CallManager6Gtest::blueToothClientPtr_ = nullptr;
std::unique_ptr<CallManagerConnect> CallManager6Gtest::servicePtr_ = nullptr;
} // namespace Telephony
} // namespace OHOS
