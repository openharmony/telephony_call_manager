...
#ifndef CALL_MANAGER7_GTEST
#define CALL_MANAGER7_GTEST
...
class CallManager7Gtest : public testing::Test {
public:
...
bool CallManager7Gtest::isConnected_ = false;
std::shared_ptr<CallManagerClient> CallManager7Gtest::clientPtr_ = nullptr;
std::shared_ptr<BluetoothCallClient> CallManager7Gtest::blueToothClientPtr_ = nullptr;
std::unique_ptr<CallManagerConnect> CallManager7Gtest::servicePtr_ = nullptr;
} // namespace Telephony
} // namespace OHOS
