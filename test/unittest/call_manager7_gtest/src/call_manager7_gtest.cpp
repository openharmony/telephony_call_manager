...
{
    if (CallManager7Gtest::clientPtr_->GetCallState() == targetState) {
        return;
    }
    int32_t usedTimeMs = 0;
    std::cout << "wait for a few seconds......" << std::endl;
    while ((CallManager7Gtest::clientPtr_->GetCallState() != targetState) && (usedTimeMs < timeoutMs)) {
        usleep(slipMs * SLEEP_1000_MS);
        usedTimeMs += slipMs;
    }
    int32_t callState = CallManager7Gtest::clientPtr_->GetCallState();
...
void CallManager7Gtest::HangUpCall()
{
 ...
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetAudioDevice_0200, Function | MediumTest | Level2)
{
    AccessToken token;
    ...
    EXPECT_EQ(CallManager7Gtest::IsServiceConnected(), true);
    ...
    int32_t ret = CallManager7Gtest::clientPtr_->DialCall(Str8ToStr16(phoneNumber), dialInfo_);
 ...
 * @tc.require: issueI5JUAQ
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetAudioDevice_0300, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: issueI5JUAQ
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetAudioDevice_0400, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: issueI5JUAQ
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetAudioDevice_0500, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: issueI5JUAQ
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetAudioDevice_0600, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.require: issueI5JUAQ
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetAudioDevice_0700, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetMuted_0100, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (CallInfoManager::HasActiveStatus()) {
        EXPECT_EQ(CallManager7Gtest::clientPtr_->SetMuted(muted), RETURN_VALUE_IS_ZERO);
    }
 ...
 * @tc.require: issueI5K59I
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetMuted_0200, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager7Gtest::clientPtr_->SetMuted(muted), CALL_ERR_AUDIO_SETTING_MUTE_FAILED);
}
 ...
 * @tc.require: issueI5K59I
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetMuted_0300, Function | MediumTest | Level2)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_RegisterCallBack_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager7Gtest::clientPtr_->RegisterCallBack(std::move(callManagerCallbackPtr)), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_UnRegisterCallBack_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager7Gtest::clientPtr_->UnRegisterCallBack(), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetCallPreferenceMode_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager7Gtest::clientPtr_->SetCallPreferenceMode(SIM1_SLOTID, mode), RETURN_VALUE_IS_ZERO);
    }
    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager7Gtest::clientPtr_->SetCallPreferenceMode(SIM2_SLOTID, mode), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetCallPreferenceMode_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetCallPreferenceMode_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetCallPreferenceMode_0400, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetCallPreferenceMode_0500, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_IsInEmergencyCall_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    bool enabled = false;
    EXPECT_EQ(CallManager7Gtest::clientPtr_->IsInEmergencyCall(enabled), TELEPHONY_SUCCESS);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_IsInEmergencyCall_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    bool enabled = false;
    EXPECT_EQ(CallManager7Gtest::blueToothClientPtr_->IsInEmergencyCall(enabled), TELEPHONY_SUCCESS);
    EXPECT_EQ(enabled, false);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_IsInEmergencyCall_0300, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    bool enabled = false;
    EXPECT_NE(CallManager7Gtest::clientPtr_->IsInEmergencyCall(enabled), TELEPHONY_SUCCESS);
    EXPECT_EQ(enabled, false);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_MuteRinger_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager7Gtest::clientPtr_->MuteRinger(), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_JoinConference_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager7Gtest::clientPtr_->JoinConference(callId, numberList), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_JoinConference_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager7Gtest::clientPtr_->JoinConference(callId, numberList), CALL_ERR_PHONE_NUMBER_EMPTY);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_ReportOttCallDetailsInfo_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager7Gtest::clientPtr_->ReportOttCallDetailsInfo(ottVec), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_ReportOttCallDetailsInfo_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager7Gtest::clientPtr_->ReportOttCallDetailsInfo(ottVec), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_ReportOttCallEventInfo_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    memcpy_s(info.bundleName, kMaxNumberLen, bundlename, strlen(bundlename));
    EXPECT_EQ(CallManager7Gtest::clientPtr_->ReportOttCallEventInfo(info), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_HasVoiceCapability_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager7Gtest::clientPtr_->HasVoiceCapability(), true);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_CloseUnFinishedUssd_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    if (HasSimCard(SIM1_SLOTID)) {
        EXPECT_EQ(CallManager7Gtest::clientPtr_->CloseUnFinishedUssd(SIM1_SLOTID), RETURN_VALUE_IS_ZERO);
    }

    if (HasSimCard(SIM2_SLOTID)) {
        EXPECT_EQ(CallManager7Gtest::clientPtr_->CloseUnFinishedUssd(SIM2_SLOTID), RETURN_VALUE_IS_ZERO);
    }
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_InputDialerSpecialCode_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_EQ(CallManager7Gtest::clientPtr_->InputDialerSpecialCode(specialCode), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_InputDialerSpecialCode_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    ...
    EXPECT_NE(CallManager7Gtest::clientPtr_->InputDialerSpecialCode(specialCode), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_InputDialerSpecialCode_0300, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
 ...
 */
HWTEST_F(
    CallManager7Gtest, Telephony_CallManager_RemoveMissedIncomingCallNotification_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    EXPECT_EQ(CallManager7Gtest::clientPtr_->RemoveMissedIncomingCallNotification(), RETURN_VALUE_IS_ZERO);
}
 ...
 */
HWTEST_F(
    CallManager7Gtest, Telephony_CallManager_RemoveMissedIncomingCallNotification_0200, Function | MediumTest | Level3)
{
    if (!HasSimCard(SIM1_SLOTID) && !HasSimCard(SIM2_SLOTID)) {
        return;
    }
    EXPECT_NE(CallManager7Gtest::clientPtr_->RemoveMissedIncomingCallNotification(), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetVoIPCallState_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    int32_t state = 0;
    EXPECT_EQ(CallManager7Gtest::clientPtr_->SetVoIPCallState(state), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetVoIPCallState_0200, Function | MediumTest | Level3)
{
    AccessToken token;
    int32_t state = 1;
    EXPECT_EQ(CallManager7Gtest::clientPtr_->SetVoIPCallState(state), RETURN_VALUE_IS_ZERO);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetVoIPCallState_0300, Function | MediumTest | Level3)
{
    AccessToken token;
    int32_t state = 2;
    EXPECT_EQ(CallManager7Gtest::clientPtr_->SetVoIPCallState(state), RETURN_VALUE_IS_ZERO);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_SetVoIPCallState_0400, Function | MediumTest | Level3)
{
    AccessToken token;
    int32_t state = 3;
    EXPECT_EQ(CallManager7Gtest::clientPtr_->SetVoIPCallState(state), RETURN_VALUE_IS_ZERO);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_GetVoIPCallState_0100, Function | MediumTest | Level3)
{
    AccessToken token;
    int32_t state = -1;
    EXPECT_EQ(CallManager7Gtest::clientPtr_->GetVoIPCallState(state), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_GetVoIPCallState_0200, Function | MediumTest | Level3)
{
    int32_t state = -1;
    EXPECT_EQ(CallManager7Gtest::clientPtr_->GetVoIPCallState(state), RETURN_VALUE_IS_ZERO);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager7Gtest, Telephony_CallManager_TestDump_0100, Function | MediumTest | Level3)
{
