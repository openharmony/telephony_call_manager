...
{
    if (CallManager8Gtest::clientPtr_->GetCallState() == targetState) {
        return;
    }
    int32_t usedTimeMs = 0;
    std::cout << "wait for a few seconds......" << std::endl;
    while ((CallManager8Gtest::clientPtr_->GetCallState() != targetState) && (usedTimeMs < timeoutMs)) {
        usleep(slipMs * SLEEP_1000_MS);
        usedTimeMs += slipMs;
    }
    int32_t callState = CallManager8Gtest::clientPtr_->GetCallState();
...
void CallManager8Gtest::HangUpCall()
{
 ...
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerService_001, Function | MediumTest | Level3)
{
    AccessToken token;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerService_002, Function | MediumTest | Level3)
{
    AccessToken token;
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    float zoomRatio = 1;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerService_003, Function | MediumTest | Level3)
{
    AccessToken token;
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerServiceStub_001, Function | MediumTest | Level3)
{
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerServiceStub_002, Function | MediumTest | Level3)
{
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerServiceStub_003, Function | MediumTest | Level3)
{
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerServiceStub_004, Function | MediumTest | Level3)
{
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerServiceStub_005, Function | MediumTest | Level3)
{
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerServiceStub_006, Function | MediumTest | Level3)
{
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerServiceStub_007, Function | MediumTest | Level3)
{
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerServiceStub_008, Function | MediumTest | Level3)
{
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    MessageParcel data6;
    MessageParcel reply;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_CallManagerServiceStub_009, Function | MediumTest | Level3)
{
    std::shared_ptr<CallManagerService> callManagerService = std::make_shared<CallManagerService>();
    MessageParcel data;
    MessageParcel reply;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManager8Gtest, Telephony_VoipCall_001, Function | MediumTest | Level3)
{
    AccessToken token;
