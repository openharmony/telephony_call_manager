...
HWTEST_F(CallManagerGtest, Telephony_CallManagerService_002, TestSize.Level1)
{
    ...
    ASSERT_GE(callManagerService->SendUssdResponse(slotId, content), TELEPHONY_SUCCESS);
...
HWTEST_F(CallManagerGtest, Telephony_CallManagerServiceStub_009, TestSize.Level0)
{
    ...
    ASSERT_NE(callManagerService->OnIsPreloadCallUI(data15, reply), TELEPHONY_SUCCESS);
