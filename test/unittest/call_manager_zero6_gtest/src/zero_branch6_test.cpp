 ...
 * @tc.desc     Function test
 */
HWTEST_F(ZeroBranch6Test, Telephony_CallStatusCallbackStub_008, Function | MediumTest | Level3)
{
    auto callStatusCallback = std::make_shared<CallStatusCallback>();
    MessageParcel dataParcel;
    dataParcel.WriteInterfaceToken(CallStatusCallbackStub::GetDescriptor());
 ...
 * @tc.desc     Function test
 */
HWTEST_F(ZeroBranch6Test, Telephony_CallStatusCallbackStub_009, Function | MediumTest | Level3)
{
    auto callStatusCallback = std::make_shared<CallStatusCallback>();
