...
HWTEST_F(ZeroBranch3Test, Telephony_CallManagerClient_002, TestSize.Level0)
{
    ...
    bool boolValue = true;
    ASSERT_GT(callManagerClient->SetRegMmiCodeCallbackState(boolValue), TELEPHONY_ERROR);
    int32_t slotId = 0;
...
HWTEST_F(ZeroBranch3Test, Telephony_CallManagerHisysevent_003, TestSize.Level0)
{
    ...
    std::string callId = "test_call_null";
    nlohmann::json nullJson = nullptr;
    callManagerHisysevent->voipProcedureCallInfo_[callId] = nullJson;
